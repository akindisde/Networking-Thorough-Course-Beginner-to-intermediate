...
This means an Ethernet frame can carry an IP packet whose maximum <u>payload</u> is 1500 bytes. Anything larger must be handled differently.
...
Take a look at the illustrated summary [[Lesson 1.4 - The_Anatomy_of_Data_Flow.pdf]]
