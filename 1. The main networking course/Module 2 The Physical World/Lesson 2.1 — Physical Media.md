...
![[Pasted image 20260906140002.png]]
...
Modern Ethernet equipment commonly supports *[[Auto-MDI or MDI-X]]*, which allows interfaces to automatically detect and compensate for the required pair configuration when pairs are crossed.

![[Cybersecurity journey/1. Networking/Definitions#🧠 - Auto-MDI/MDI-X|Definitions]]
...
![[Cybersecurity journey/1. Networking/Terminology#𝑨 - Miswire|Terminology]]
...
![[Pasted image 20260906135201.png]]

This is why professional *cable certification* is more sophisticated than simply checking continuity.

![[Cybersecurity journey/1. Networking/Definitions#🧠 - Cable certification|Definitions]]
...
![[Pasted image 20260906140040.png]]

<mark style="background:#fff88f">A cable can have perfect continuity and still fail to meet the performance requirements of its category.</mark>
...
A problem may occur <u>anywhere</u> along the path.

### *Cable Tracing*

![[Cybersecurity journey/1. Networking/Definitions#🧠 - Cable tracing|Definitions]]
...
Tracing cables is not only a technical task. <u>It is also a security task.</u>
...
<mark style="background:#fff88f">A physical network can have strong logical security and still be poorly protected physically.</mark>
